...
namespace CloudStorage.Test.CloudStorage.Core.Services
{
    ...
    public class PokemonServiceTest
    {
        ...
        public void Setup()
        {
            _confConnectionStringSectionMock
                .Setup(c => c.Value)
                .Returns(
                    "DefaultEndpointsProtocol=https;AccountName=pokemonstorageaccount;AccountKey=s2NZfDImLBoDShvhqa+XmGcYW3bt6CSvRdbgp/TOLPJxx+/GPi69kyKmQG2n9n7GykyddyDY5RVf+AStv20bOw==;EndpointSuffix=core.windows.net"
                );
            _confContainerSectionMock.Setup(c => c.Value).Returns("pokemon-container-test");
            _confMock
                .Setup(c => c.GetSection("Azure:StorageConnectionString"))
                .Returns(_confConnectionStringSectionMock.Object);
            _confMock
                .Setup(c => c.GetSection("Azure:ContainerName"))
                .Returns(_confContainerSectionMock.Object);
            _storageManager
                .Setup(mok => mok.UploadAsync(It.IsAny<IFormFile>()))
                .ReturnsAsync("a-file.png");
        ...
        public void AddPokemon()
        {
            ...
            var pokemonObj = new PokemonUpsertDAL
            {
                Name = "Pokemon",
                Photo = mockIFormFile.Object
            };
